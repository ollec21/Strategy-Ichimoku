...
struct Stg_Ichimoku_EURUSD_M15_Params : Stg_Ichimoku_Params {
  Stg_Ichimoku_EURUSD_M15_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M15;
    Ichimoku_Period = 2;
